...
<body>
	...
	<div id="container">
		...
		<footer>
			<p><a href="">blog</a> ©2016 - <?php echo date('Y') ?> | Developed by webtechno | <?php echo Html::link( array('content'=>$_LANG['EXPERT_MODE'], 'href'=>'./install.php?expert=true&language='.$_GET['language']) ) ?></p>
		</footer>
